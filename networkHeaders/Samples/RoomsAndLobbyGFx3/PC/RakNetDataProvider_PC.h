...
#ifndef INC_RakNetDataProvider_H
#define INC_RakNetDataProvider_H

// RakNet information
// WindowsIncludes must be before #include <windows.h>
...
class RakNetDataProvider_PC : public LobbyDataProvider, RakNet::Lobby2Callbacks, RakNet::RoomsCallback
{
public:
    RakNetDataProvider_PC();
    ~RakNetDataProvider_PC();
